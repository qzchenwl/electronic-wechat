...
electron-packager . "${APP_NAME}" --platform=$PLATFORM --arch=$ARCH --version=1.4.1 --app-version=1.4.0 --asar --icon=assets/icon.icns --overwrite --out=./dist --ignore=${ignore_list}
